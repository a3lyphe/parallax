var ZeitCounter=0;
	...
	function BodenAnimation(){
		...
		document.getElementById("Kiste1").style.left=KistenCounter*30-226+'px';
		document.getElementById("Kiste2").style.left=KistenCounter*30+26+'px';
		document.getElementById("Kiste3").style.left=KistenCounter*30+226+'px';
		document.getElementById("Kiste4").style.left=KistenCounter*30+426+'px';
		document.getElementById("Kiste5").style.left=KistenCounter*30+726+'px';
		document.getElementById("Kiste6").style.left=KistenCounter*30+826+'px';
